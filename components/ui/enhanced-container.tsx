  ...
  ({ 
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "bg-white dark:bg-slate-800 border border-black",
          ...
          variant === 'nested' && "bg-gray-50 dark:bg-slate-750 border border-black rounded-lg",
          variant === 'interactive' && "cursor-pointer hover:-translate-y-0.5",
          priority === 'primary' && "border-black shadow-light-card dark:shadow-glow-soft hover:border-black",
